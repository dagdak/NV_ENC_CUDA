...
protected:
    ...
    CUmodule                                             m_cuModule;
    CUfunction                                           m_cuRGB2NV12Function;
    CUdeviceptr                                          m_RGBDevPtr;
    CUarray                                              m_RGBArrayPtr;
...
protected:
    NVENCSTATUS                                          MapGLTexToCU(CUdeviceptr* cudevicePtr, GLuint colorTex, int width, int height);
    NVENCSTATUS                                          CopyArrayToDevice(CUdeviceptr* cudevicePtr, int width, int height);
    ...
    NVENCSTATUS                                          ConvertRGBToNV12(EncodeBuffer *pEncodeBuffer, unsigned char *rgb, int width, int height);
    NVENCSTATUS                                          LoadRGB(EncodeBuffer *pEncodeBuffer, unsigned char *rgb, int width, int height);
public:
